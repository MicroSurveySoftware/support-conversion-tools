...
returnlink = 'http://support.microsurvey.com/convert/template.html'
...
#Insert script below:
    ...
    if not 'formvalue_text' in form:
        ...
        pulldowninput = form.getvalue('formvalue_pulldown')
        text = form.getvalue('content')


 
    output_text += textinput + "\n"
    output_text += radioinput + "\n"
    output_text += pulldowninput + "\n"
    output_text += text + "\n"
