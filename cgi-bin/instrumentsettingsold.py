...
returnlink = 'https://support.microsurvey.com/convert/instrumentsettings.html'
output_text = 'Created ' + time.strftime('%B %d, %Y -- %I:%M:%S %p %Z') + '<br />Instrument Settings script by MicroSurvey -- helpdesk@MicroSurvey.com<br /> Script Version 1.2 -- March 11, 2018<br />'
...
output_text += '<font face="courier">' + "<br><br><strong>Conventional:</strong><br>\n"
output_text += 'Device Constant:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + str(deviceconstant) + "<br>\n"
output_text += "Distance PPM:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + str(distanceppm) + "<br>\n"
...
output_text += "&nbsp;&nbsp;&nbsp;Vertical:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + str(vert) + "<br></font>\n"


output_text += "<br><br><br>If you wish to add this result to your instrument library you may paste the entry below into the Company.def file<br>\n"
output_text += "Open the Company.def file found in: C:\ProgramData\MicroSurvey\StarNet\V* with a text editor.<br>\n"
output_text += "Paste the entry below at the bottom of the file, modify the instrument_name and save.<br><br><br>\n"
...
print '<a href="https://helpdesk.microsurvey.com/index.php?/Knowledgebase/Article/View/1465">See this article for details of computations made.</a>'  
print "</div>"
print "</body>"
print "</html>"
