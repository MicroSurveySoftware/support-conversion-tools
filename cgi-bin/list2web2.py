...
output_text = 'Created ' + time.strftime('%B %d, %Y -- %I:%M:%S %p %Z') + '<br />List2HTML script by MicroSurvey -- helpdesk@MicroSurvey.com<br /> Script Version 1.0 -- 12 10, 2017<br />'
...
#output += "<!DOCTYPE html><html><title>STAR*NET HTML Listing</title><body>"
#output += '<p><img src="http://microsurvey.com/dealers/files/Logo_STARNET.png" alt="STAR*NET" align="middle"> </p>'
...
#problem to solve: online python can't spot the carriage returns in text:
...
##        i = table[1]
        ...
        curLine = curLine.replace(' ','&nbsp;')
        #output += '<p style="font-family:courier;">' + curLine + '<br>'
        output += '<font face="courier">' + curLine + '</font><br>'
        i += 1
